About stomp.py-feedstock
========================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/stomp.py-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=4354&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/stomp.py-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `stomp.py` can be installed with `conda`:
...
```
mamba install stomp.py
```

It is possible to list all of the versions of `stomp.py` available on your platform with `conda`:
...
```
mamba search stomp.py --channel conda-forge
```
...
mamba repoquery search stomp.py --channel conda-forge

# List packages depending on `stomp.py`:
mamba repoquery whoneeds stomp.py --channel conda-forge

# List dependencies of `stomp.py`:
mamba repoquery depends stomp.py --channel conda-forge
```
